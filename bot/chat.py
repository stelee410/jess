...
class OpenAIBot():
    def __init__(self,initMsg,feeds, context ={},version="1.0") -> None: #context is the context of the conversation
...
class ExplorerBot(OpenAIBot):
    def __init__(self,initMsg,feeds, version="1.0") -> None:
        super().__init__(initMsg,feeds,{}, version)
        prompt = f"""
...
class GPT4Bot(OpenAIBot):
    def __init__(self,initMsg,feeds, context, version="1.0") -> None:
        super().__init__(initMsg,feeds,context,version)
        self.model = "gpt-3.5-turbo-16k"
        self.temperature = 1.0
